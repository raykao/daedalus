...
- E2E test harness for AKS deployments (Phase 5.4): `test/e2e/aks/aks_e2e_test.go` gated by `aks_e2e` build tag, Makefile target `test-aks-e2e`, `aks.env.example`, fixtures.
