...
import (
	...
	"github.com/raykao/daedalus/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(daedalusv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3acd3b34.daedalus.dev",
	...
	if err := (&controller.AgentRuntimeReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "AgentRuntime")
		os.Exit(1)
	}
	if err := (&controller.ModelConfigReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "ModelConfig")
		os.Exit(1)
	}
	...
	if err := (&controller.TaskPipelineReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "TaskPipeline")
		os.Exit(1)
	}
